...
** Home‑manager module
This example integrates with Stylix. Here =colorHash.<color>= is a color with a hash string, e.g. ="#1e1e2e"=.
#+begin_src nix
{
  config,
  pkgs,
  ...
  colorHash = config.lib.stylix.colors.withHashtag;
  light = colorHash.base07;
  accent = colorHash.base0D;

  wallpaper = inputs.nix-wallpaper.packages.${pkgs.system}.default.override {
    width = 7680;
    height = 2160;
    backgroundColor = colorHash.base00;
